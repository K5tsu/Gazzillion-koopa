...
MODULE_AUTHOR("K5tsu and that one voice in my head");
MODULE_DESCRIPTION("illest koopa");
MODULE_VERSION("1");
...
static void __exit mod_exit(void){
    ...
    printk(KERN_INFO "KOOPA:: Successfully unloaded\n");
}

static int __init mod_init(void){
    int err;
    #ifdef VERSION_NOT_SUPPORTED
        printk(KERN_INFO "KOOPA:: Version not supported\n");
        return -1;
    #endif
    ...
    printk(KERN_INFO "KOOPA:: Successfully loaded\n");
